        ...
        b.define("select2/results", ["jquery", "./utils"], function(a, b) {
          ...
          return (
            ...
            (c.prototype.showLoading = function(a) {
              this.hideLoading();
              const b = this.options.get("translations").get("searching"),
            ...
            (c.prototype.template = function(b, c) {
              const d = this.options.get("templateResult"),
          ...
          function(a, b, c, d) {
            ...
            return (
              ...
              (e.prototype.display = function(a, b) {
                const c = this.options.get("templateSelection"),
        ...
        b.define("select2/selection/placeholder", ["../utils"], function(a) {
          ...
          return (
            ...
            (b.prototype.update = function(a, b) {
              const c = 1 == b.length && b[0].id != this.placeholder.id,
                d = b.length > 1;
                  ...
                  this.$selection.on(
                    ...
                    function(a) {
                      ...
                      if (b === c.BACKSPACE && "" === e.$search.val()) {
                        const d = e.$searchContainer.prev(
        ...
        b.define(
          ...
          function(a, b, c) {
            ...
            return (
              b.Extend(d, a),
              (d.prototype.select = function(a) {
                let b = this.$element.find("option").filter(function(b, c) {
        ...
        b.define("select2/i18n/en", [], function() {
          return {
            ...
            inputTooShort: function(a) {
              const b = a.minimum - a.input.length,
          ...
          function(
            ...
            (D.prototype.apply = function(l) {
              ...
              if (a.isArray(l.language)) {
                ...
                const Q = k.loadPath(this.defaults.amdLanguageBase + "en"),
                  R = new k(l.language);
                ...
                function c(d, e) {
                  ...
                  if (e.children && e.children.length > 0) {
                    for (
                      ...
                      const h = e.children[g],
                        i = c(d, h);
                      null == i && f.children.splice(g, 1);
                    }
                    return f.children.length > 0 ? f : c(d, f);
                  }
                  const j = b(e.text).toUpperCase(),
            ...
            return (
              ...
              (e.prototype._resolveWidth = function(a, b) {
                ...
                if ("style" == b) {
                  ...
                  for (
                    let g = f.split(";"), h = 0, i = g.length;
                    i > h;
                    h += 1
                  ) {
                    const j = g[h].replace(/\s/g, ""),
                      k = j.match(c);
